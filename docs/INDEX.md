...
| `docs/adr/0023-system-session-events-topic.md` | adr | [convergio-bus, convergio-server, convergio-mcp, convergio-api] | proposed | 285 |
| `docs/adr/README.md` | adr | - | - | 39 |
...
| `docs/prd/0001-claude-code-adapter.md` | - | - | proposed | 339 |
| `docs/release.md` | - | - | - | 106 |
| `docs/setup.md` | - | - | - | 102 |
